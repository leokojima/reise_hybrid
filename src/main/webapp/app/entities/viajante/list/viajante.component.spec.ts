...
describe('Component Tests', () => {
  describe('Viajante Management Component', () => {
    let comp: ViajanteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ViajanteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.viajantes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
