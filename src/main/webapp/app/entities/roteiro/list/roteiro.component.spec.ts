...
describe('Component Tests', () => {
  describe('Roteiro Management Component', () => {
    let comp: RoteiroComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RoteiroComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.roteiros?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
