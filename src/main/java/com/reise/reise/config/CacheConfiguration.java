package com.reise.reise.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.reise.reise.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.reise.reise.repository.UserRepository.USERS_BY_EMAIL_CACHE);
